    ...
    <div class="relative mb-6 w-full">
        <div class="flex items-center justify-between">
            <div>
                ...
                <flux:subheading size="lg" class="mb-6">Create a new question</flux:subheading>
            </div>
            <div class="space-x-2">
                <flux:button variant="danger" size="sm"
                    :href="route('admin.psychometrics.tests.questions.index', $test->id)" icon="arrow-uturn-left"
                    ...
                    <div class="space-y-2">
                        ...
                        <div wire:ignore>
                            <select x-data x-init="new TomSelect($el, {
                                                            ...
                                                            maxItems: 1
                                                        })" wire:model.defer="answer_type" class="w-full">
                                <option value="">Select answer type</option>
                                <option value="open_ended">Text (Single Line)</option>
                                <option value="text_area">Textarea (Multi-line)</option>
